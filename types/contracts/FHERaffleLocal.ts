...
export interface FHERaffleLocalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createRaffle"
      | "drawWinner"
...
export interface FHERaffleLocal extends BaseContract {
  connect(runner?: ContractRunner | null): FHERaffleLocal;
  waitForDeployment(): Promise<this>;

  interface: FHERaffleLocalInterface;
  ...
  enterRaffle: TypedContractMethod<
    [raffleId: BigNumberish, amount: BigNumberish],
    [void],
    "payable"
  >;
  ...
  filters: {
    "EntrySubmitted(uint256,address,uint256,uint64)": TypedContractEvent<
      EntrySubmittedEvent.InputTuple,
      EntrySubmittedEvent.OutputTuple,
      EntrySubmittedEvent.OutputObject
    >;
    ...
    "RaffleDrawn(uint256,address,uint256,uint64)": TypedContractEvent<
      RaffleDrawnEvent.InputTuple,
      RaffleDrawnEvent.OutputTuple,
      RaffleDrawnEvent.OutputObject
    >;
